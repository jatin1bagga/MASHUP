...
app.config['MAIL_USERNAME'] = 'aloc1345@gmail.com'  # my email
app.config['MAIL_PASSWORD'] = 'pnzg zobg juxp gnzg'  # my app password
app.config['MAIL_DEFAULT_SENDER'] = 'jbagga_be22@thapar.edu'  # my email
mail = Mail(app)
...
def download_videos(singer, number_of_videos):
    ...
    ydl_opts = {
        ...
        'format' : 'best',
        'noplaylist' : True,
        'max_downloads' : number_of_videos,
    }
